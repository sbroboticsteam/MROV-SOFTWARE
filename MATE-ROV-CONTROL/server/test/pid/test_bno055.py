...
# Configure logging
logger = logging.getLogger("ROV.Sensors.BNO055")
...
class BNO055Sensor:
    """BNO055 IMU sensor class for ROV orientation sensing with sensor fusion"""
    ...
    def __init__(self, bus_number=7):
        ...
        # One for each Euler angle: heading, roll, pitch
    ...
    def initialize_sensors(self):
        ...
        try:
            ...
            if who_am_i == 0x6C:  # Verify with actual datasheet
        ...
        # Try to initialize LIS3MDL (Magnetometer)
        try:
            # Check LIS3MDL ID
        ...
        # Log overall status
        logger.info(f"IMU Sensors initialized: BNO055={self.bno055_available}, "
                   f"LSM6DOS={self.lsm6dos_available}, LIS3MDL={self.lis3mdl_available}")
    ...
    def read_bno055_data(self):
        ...
        try:
            ...
            cal_status = self.bus.read_byte_data(BNO055_ADDRESS, BNO055_CALIB_STAT)
    ...
    def read_lis3mdl_data(self):
        """Read data from LIS3MDL magnetometer"""
    ...
    def update_kalman_filters(self, bno055_data, lsm6dos_data, lis3mdl_data):
        ...
        fused_data = {
            ...
            'sensor_status': {
                'bno055': self.bno055_available,
                'lsm6dos': self.lsm6dos_available,
                'lis3mdl': self.lis3mdl_available
            }
        }
    ...
    def close(self):
        ...
        try:
            ...
            logger.error(f"Error closing IMU sensor connection: {e}")
